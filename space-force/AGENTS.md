# Space Force Agent Notes

This file is game-specific guidance for `space-force/` and is additive to the repo root `AGENTS.md`.

## Scope + Source of Truth

- Applies to files under `space-force/`.
