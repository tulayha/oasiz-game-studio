...
- App logs (`pm2 logs astro-party-colyseus --time`)
...
- `/tmp/astro-observe/<runId>/pm2.log`
- `/tmp/astro-observe/<runId>/kernel.log`
- `/tmp/astro-observe/<runId>/metrics.log`
- `/tmp/astro-observe/<runId>/meta.json`
- `/tmp/astro-observe/<runId>.tar.gz`

### 2) Local Orchestrator

File target:

- `astro-party/server/loadtest/run-observed-loadtest.ps1`
...
- `astro-party/server/observed-runs/`
...
- `astro-party/server/observed-runs/dashboard/index.html` (or static app files)
