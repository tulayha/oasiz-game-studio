...
import { AstroPartySimulation } from "../shared/sim/AstroPartySimulation.js";
import {
...
function advanceToPlaying(sim: AstroPartySimulation): void {
  const maxTicks = 900;
...
function scenarioDeadShooterStillScoresNoComboAdvance(): ScenarioResult {
  const sim = new AstroPartySimulation("SIM_TEST", 4, 1000 / 60, createNoopHooks(), {
