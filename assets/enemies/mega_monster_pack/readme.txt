...
Hello! Thank you for downloading the Mega Monster Pack. Here are a few pointers to help you navigate and make sense of this zip file.

- In the root folder, you will find folders corresponding to each monster.

- In any of the monster folders, you will find a folder named PNG. This folder contains the animation frames of the monster as individual PNGs. Each animation has its own folder.

- In the monster folders, you will also find a folder named spritesheet. This folder contains the spritesheets for each monster as well as a metadata file for parsing the spritesheet.
